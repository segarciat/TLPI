/* Modified by Sergio E. Garcia Tapia for Exercise 57-2 */
...
/* Exercise 57-2 (based on Listing 57-3) */

/* us_xfr_linux_sns_sv.c

   An example UNIX stream socket server. Accepts incoming connections
   and copies data sent from clients to stdout.

   See also us_xfr_linux_sns_cl.c.
*/
#include "us_xfr_linux_sns.h"
#define BACKLOG 5
